        ...
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            @if (! $role)
                <div class="flex justify-between">
                    <button class="btn btn-primary" wire:click="registerAsEmployer">Register as Employer</button>
                    <button class="btn btn-primary btn-primary--light" wire:click="registerAsJobseeker">Register as Jobseeker</button>
                </div>
            @endif
            @if ($role)
